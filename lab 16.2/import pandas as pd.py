# data_preprocessing_students_no_pandas.py
# --------------------------------------------
# This script generates a student dataset,
# fills missing values with column means,
# performs one-hot encoding manually,
# and saves the cleaned dataset to processed_students.csv
# No external libraries (like pandas) are required.
# --------------------------------------------
